    ...
    project: { accounts: [
      {
        ...
        entries:[
          { id:'pe1', type:'personnel', item:'黃俊皓', role:'專任助理人員（高級）', period:'115年04–06月份薪資（1150401-1150831）',
            baseSalary:77000, pension:4812, laborIns:4008, healthIns:3881, workInjuryIns:80, applied:269343, actual:269343, note:'聘任完成' },
          { id:'pe2', type:'personnel', item:'周怡均', role:'專任助理人員（中級）', period:'115年04–06月份薪資（1150401-1150831）',
            baseSalary:50000, pension:3036, laborIns:4008, healthIns:2449, workInjuryIns:56, applied:178479, actual:178479, note:'聘任完成' },
          { id:'pe3', type:'personnel', item:'郭乃維', role:'專任助理人員（中級，轉院聘）', period:'115年04–06月份薪資（1150401-1150831）',
            baseSalary:63000, pension:3828, laborIns:4008, healthIns:3087, workInjuryIns:70, applied:221979, actual:221979, note:'聘任完成' },
          { id:'pe4', type:'misc', orderNo:'11412680（20260414上單）', item:'課程費', desc:'ISO42001主導稽核員課程（8小時/天，共5日），上限25人', unit:'人', qty:25, unitPrice:20580, applied:514500, actual:462500, note:'5/11限制性招標決標，決標價18,500/人 × 25人' },
          { id:'pe5', type:'misc', orderNo:'11414821（20260525上單）', item:'領證費', desc:'雙側肺浸潤查驗登記領證費', unit:'次', qty:1, unitPrice:1500, applied:1500, actual:1500, note:'核銷完成（入主任）2026.07.24已付款' },
          { id:'pe6', type:'misc', orderNo:'11416348（20260617上單）', item:'軟體工具使用費（2026.07月份）', desc:'Claude Pro／ChatGPT Plus／iCloud／Claude Max 續訂（主任、王副等）', unit:'月', qty:1, unitPrice:700, applied:634, actual:7980, note:'核銷中：轉送水湳 7/28（入主任及王副）' },
          { id:'pe7', type:'equipment', orderNo:'115A061306（20260618上單）', item:'個人電腦', desc:'ASUS 華碩 Ascent GX10 桌上型 AI 超級電腦（心導管室用）', unit:'台', qty:1, unitPrice:190000, applied:190000, actual:170000, note:'申請中：7/13 決標（米多多），決標價 170,000' },
          { id:'pe8', type:'equipment', orderNo:'115A070466（20260727上單）', item:'人工智慧電腦', desc:'Blackwell GPU、20-core Arm CPU、128GB', unit:'台', qty:2, unitPrice:210000, applied:420000, actual:420000, note:'申請中：莊千蔓（威雲）' },
        ]
      }
    ]},
  }
